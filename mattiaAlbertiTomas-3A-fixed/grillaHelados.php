    ...
    <?php
        ...
        <table align="center">
            ...
            <?php
                ...
                {
                    echo "<tr><td>".$hel->GetSabor()." ".$hel->PrecioMasIva()."</td>"."<td><img src='./heladosArchivo/heladosImagen/".$hel->GetPathFoto().".jpg' alt='".$hel->GetSabor()."' style='width:90px;height:90px;'></td><td>"; 
                }
            ?> 
            <tr><td colspan="4"><hr></td></tr>
        </table>
